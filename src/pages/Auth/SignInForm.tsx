...
const SignInForm = ({initialValues, onSubmit}: LoginFormProps) => {
    ...
    const handleDemo = () => {
        setValue('username', 'admin@demo.com')
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Input className='my-6' {...register('username')} placeholder='Username or Email address' type='text'/>
